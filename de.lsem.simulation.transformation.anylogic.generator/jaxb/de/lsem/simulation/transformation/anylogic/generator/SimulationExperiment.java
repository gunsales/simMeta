...
public class SimulationExperiment implements java.io.Serializable {
     ...
     * Field _frame.
     */
    private de.lsem.simulation.transformation.anylogic.generator.Frame _frame;
     ...
     * Field _shapes.
     */
    private de.lsem.simulation.transformation.anylogic.generator.Shapes _shapes;

    /**
     * Field _controls.
     */
    private de.lsem.simulation.transformation.anylogic.generator.Controls _controls;
     ...
     */
    private de.lsem.simulation.transformation.anylogic.generator.PresentationProperties _presentationProperties;

    /**
     * Field _modelTimeProperties.
     */
    private de.lsem.simulation.transformation.anylogic.generator.ModelTimeProperties _modelTimeProperties;
     ...
     */
    public de.lsem.simulation.transformation.anylogic.generator.Controls getControls(
    ) {
     ...
     */
    public de.lsem.simulation.transformation.anylogic.generator.Frame getFrame(
    ) {
        return this._frame;
    }
     ...
     */
    public de.lsem.simulation.transformation.anylogic.generator.ModelTimeProperties getModelTimeProperties(
    ) {
     ...
     */
    public de.lsem.simulation.transformation.anylogic.generator.PresentationProperties getPresentationProperties(
    ) {
     ...
     */
    public de.lsem.simulation.transformation.anylogic.generator.Shapes getShapes(
    ) {
        return this._shapes;
    }
    ...
    public void setControls(
            final de.lsem.simulation.transformation.anylogic.generator.Controls controls) {
    ...
    public void setFrame(
            final de.lsem.simulation.transformation.anylogic.generator.Frame frame) {
        this._frame = frame;
    }
    ...
    public void setModelTimeProperties(
            final de.lsem.simulation.transformation.anylogic.generator.ModelTimeProperties modelTimeProperties) {
    ...
    public void setPresentationProperties(
            final de.lsem.simulation.transformation.anylogic.generator.PresentationProperties presentationProperties) {
    ...
    public void setShapes(
            final de.lsem.simulation.transformation.anylogic.generator.Shapes shapes) {
        this._shapes = shapes;
    }
