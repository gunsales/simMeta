 ...
 * 
 */
public class UpdateSimulationElementFeature extends AbstractUpdateFeature {

	private static final Logger logger = Logger
			.getLogger(UpdateSimulationElementFeature.class.getSimpleName());

	public UpdateSimulationElementFeature(IFeatureProvider fp) {
		super(fp);
	}
