...
public class SourceFirstEntitySection extends SourceAbstractEntitySection {

	private static final Logger logger = Logger
			.getLogger(SourceFirstEntitySection.class.getSimpleName());
